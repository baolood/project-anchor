...
KILL_SWITCH_UI_E2E_PASS=NO
PANIC_GUARD_UI_E2E_PASS=NO
PANIC_GUARD_COOLDOWN_E2E_PASS=NO
CLOSURE_PASS=NO
PASS_OR_FAIL=FAIL
FAIL_REASON=""
...
echo "=============================="
echo "verify_all_e2e: Step 2p — checklist_ops_dashboard_ui_e2e.sh"
echo "=============================="
ops_dashboard_ui_out="${OPS_DASHBOARD_UI_E2E_OUT:-/tmp/anchor_e2e_checklist_ops_dashboard_ui_e2e_last.out}"
OUT="$ops_dashboard_ui_out" CONSOLE_URL="${CONSOLE_PRECHECK:-http://127.0.0.1:3000}" \
   bash "$ROOT/scripts/checklist_ops_dashboard_ui_e2e.sh" 2>&1 | tee "$ops_dashboard_ui_out" || true

if grep -q "PASS_OR_FAIL=PASS" "$ops_dashboard_ui_out"; then
  OPS_DASHBOARD_UI_E2E_PASS=YES
else
  echo "OPS_DASHBOARD_UI_E2E_PASS=NO"
  echo "MODULE=verify_all_e2e"
  echo "RETRY_E2E_PASS=$RETRY_E2E_PASS"
  echo "EVENTS_E2E_PASS=$EVENTS_E2E_PASS"
  echo "QUOTE_E2E_PASS=$QUOTE_E2E_PASS"
...
OUT="$kill_switch_ui_out" CONSOLE_PRECHECK="${CONSOLE_PRECHECK:-http://127.0.0.1:3000}" \
   bash "$ROOT/scripts/checklist_kill_switch_ui_e2e.sh" 2>&1 | tee "$kill_switch_ui_out" || true

if grep -q "PASS_OR_FAIL=PASS" "$kill_switch_ui_out"; then
  KILL_SWITCH_UI_E2E_PASS=YES
else
  echo "KILL_SWITCH_UI_E2E_PASS=NO"
  echo "MODULE=verify_all_e2e"
  echo "RETRY_E2E_PASS=$RETRY_E2E_PASS"
  echo "EVENTS_E2E_PASS=$EVENTS_E2E_PASS"
  echo "QUOTE_E2E_PASS=$QUOTE_E2E_PASS"
  ...
  echo "OPS_STATE_E2E_PASS=$OPS_STATE_E2E_PASS"
  echo "OPS_DASHBOARD_UI_E2E_PASS=$OPS_DASHBOARD_UI_E2E_PASS"
  echo "KILL_SWITCH_UI_E2E_PASS=$KILL_SWITCH_UI_E2E_PASS"
  echo "RISK_PANEL_UI_E2E_PASS=$RISK_PANEL_UI_E2E_PASS"
  echo "CLOSURE_PASS=$CLOSURE_PASS"
  echo "PASS_OR_FAIL=FAIL"
  echo "FAIL_REASON=kill_switch_ui_e2e_failed"
  exit 1
fi
...
echo "=============================="
echo "verify_all_e2e: Step 2q3 — checklist_panic_guard_ui_e2e.sh"
echo "=============================="
panic_guard_ui_out="${PANIC_GUARD_UI_E2E_OUT:-/tmp/anchor_e2e_checklist_panic_guard_ui_e2e_last.out}"
OUT="$panic_guard_ui_out" CONSOLE_PRECHECK="${CONSOLE_PRECHECK:-http://127.0.0.1:3000}" \
   bash "$ROOT/scripts/checklist_panic_guard_ui_e2e.sh" 2>&1 | tee "$panic_guard_ui_out" || true

if grep -q "PASS_OR_FAIL=PASS" "$panic_guard_ui_out"; then
  PANIC_GUARD_UI_E2E_PASS=YES
else
  echo "PANIC_GUARD_UI_E2E_PASS=NO"
  echo "MODULE=verify_all_e2e"
  echo "RETRY_E2E_PASS=$RETRY_E2E_PASS"
  echo "EVENTS_E2E_PASS=$EVENTS_E2E_PASS"
  echo "QUOTE_E2E_PASS=$QUOTE_E2E_PASS"
  ...
  echo "OPS_DASHBOARD_UI_E2E_PASS=$OPS_DASHBOARD_UI_E2E_PASS"
  echo "KILL_SWITCH_UI_E2E_PASS=$KILL_SWITCH_UI_E2E_PASS"
  echo "PANIC_GUARD_UI_E2E_PASS=$PANIC_GUARD_UI_E2E_PASS"
  echo "RISK_PANEL_UI_E2E_PASS=$RISK_PANEL_UI_E2E_PASS"
  echo "CLOSURE_PASS=$CLOSURE_PASS"
  echo "PASS_OR_FAIL=FAIL"
  echo "FAIL_REASON=panic_guard_ui_e2e_failed"
  exit 1
fi
...
echo "=============================="
echo "verify_all_e2e: Step 2q4 — checklist_panic_guard_cooldown_e2e.sh"
echo "=============================="
panic_guard_cooldown_out="${PANIC_GUARD_COOLDOWN_E2E_OUT:-/tmp/anchor_e2e_checklist_panic_guard_cooldown_e2e_last.out}"
OUT="$panic_guard_cooldown_out" CONSOLE_PRECHECK="${CONSOLE_PRECHECK:-http://127.0.0.1:3000}" \
   bash "$ROOT/scripts/checklist_panic_guard_cooldown_e2e.sh" 2>&1 | tee "$panic_guard_cooldown_out" || true

if grep -q "PASS_OR_FAIL=PASS" "$panic_guard_cooldown_out"; then
  PANIC_GUARD_COOLDOWN_E2E_PASS=YES
else
  echo "PANIC_GUARD_COOLDOWN_E2E_PASS=NO"
  echo "MODULE=verify_all_e2e"
  echo "RETRY_E2E_PASS=$RETRY_E2E_PASS"
  echo "EVENTS_E2E_PASS=$EVENTS_E2E_PASS"
  echo "QUOTE_E2E_PASS=$QUOTE_E2E_PASS"
  ...
  echo "KILL_SWITCH_UI_E2E_PASS=$KILL_SWITCH_UI_E2E_PASS"
  echo "PANIC_GUARD_UI_E2E_PASS=$PANIC_GUARD_UI_E2E_PASS"
  echo "PANIC_GUARD_COOLDOWN_E2E_PASS=$PANIC_GUARD_COOLDOWN_E2E_PASS"
  echo "RISK_PANEL_UI_E2E_PASS=$RISK_PANEL_UI_E2E_PASS"
  echo "CLOSURE_PASS=$CLOSURE_PASS"
  echo "PASS_OR_FAIL=FAIL"
  echo "FAIL_REASON=panic_guard_cooldown_e2e_failed"
  exit 1
fi
