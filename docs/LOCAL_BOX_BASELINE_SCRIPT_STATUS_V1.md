...
- 详见运行与日志留痕：**`docs/LOCAL_BOX_BASELINE_WORKFLOW_RUN_EVIDENCE_V1.md`**（含首次失败、`local_box` 入库后成功、merge 至 **`main`** 后的运行；**`main`** 上对提交 **`9c6805a`** 的 workflow run：**#7** / **[`24643718594`](https://github.com/baolood/project-anchor/actions/runs/24643718594)**）。
