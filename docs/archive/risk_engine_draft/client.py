"""Archived risk_engine draft client (historical snapshot).

Original path: ``risk_engine/client.py`` (untracked). Not a risk model — thin HTTP
client for ``execution_service`` (see ``docs/RISK_ENGINE_PENDING_DECISION_RECORD_V1.md``).
"""
