...
| `risk_engine/client.py` | **已归档入库** **`docs/archive/risk_engine_draft/client.py`**（见 **`RISK_ENGINE_PENDING_DECISION_RECORD_V1.md`** **§9**） |
| `shared/schemas.py`（及 **`shared/__init__.py`**） | **已升格跟踪**（见 **`SHARED_SCHEMAS_PENDING_DECISION_RECORD_V1.md`** **§10**） |
...
- **`shared/schemas.py`**（及 **`shared/__init__.py`**）已 **升格跟踪**，见 **`SHARED_SCHEMAS_PENDING_DECISION_RECORD_V1.md`** **§10**。
- **`risk_engine/client.py`** 已 **归档入库**至 **`docs/archive/risk_engine_draft/client.py`**，见 **`RISK_ENGINE_PENDING_DECISION_RECORD_V1.md`** **§9**。
